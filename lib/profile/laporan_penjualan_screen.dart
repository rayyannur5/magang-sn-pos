...
class LaporanPenjualanScreen extends StatelessWidget {
          ...
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: const [
                  Text('Banyak Penjualan : 2 transaksi', style: TextStyle(fontFamily: 'Poppins', fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white)),
                  Text('Omset                             : Rp 16.000,00', style: TextStyle(fontFamily: 'Poppins', fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white)),
                ],
              ),
            ),
          ),
  ...
  Container cardLaporanPenjualan(Size size) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: size.width / 15),
